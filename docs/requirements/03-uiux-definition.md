...
キー未設定                           プロフィール未作成
┌──────────────────────────┐      ┌──────────────────────────┐
│ ◉ Auto Form Filler   ⚙   │      │ ◉ Auto Form Filler   ⚙   │
├──────────────────────────┤      ├──────────────────────────┤
│ ⚠ API キーが未設定です      │      │ プロフィールがありません     │
│                          │      │                          │
│ Jev の API キーを設定すると  │      │ 氏名や住所を登録すると       │
│ 使えるようになります。       │      │ 入力できるようになります。    │
│                          │      │                          │
│ [API キーを設定する]        │      │ [プロフィールを作成する]     │
└──────────────────────────┘      └──────────────────────────┘
```
...
│ [プロフィール] [API 設定] [動作設定] [プライバシー]                │
├────────────────────────────────────────────────────────────────┤
│ プロバイダ   (●) OpenRouter   ( ) TypeSafe                       │
│                                                                │
│ API キー    [••••••••••••••••••••••••abcd     ] [表示]           │
│             [接続テスト]  ✓ 接続できました（312ms）                │
│                                                                │
│ キーの取得方法                                                  │
│  1. openrouter.ai でアカウントを作成                              │
│  2. Credits で少額をチャージ（1 フォーム約 0.03 円）                │
│  3. Keys で新しいキーを作成し、上に貼り付け                         │
│                                                                │
│ ⓘ キーはこの端末の Chrome 内にのみ保存され、Jev の呼び出しにだけ    │
│   使われます。エクスポートにも含まれません。                        │
│                                                                │
│ ▸ 詳細設定（モデル名の上書き）                                    │
│                                                    [保存]      │
└────────────────────────────────────────────────────────────────┘
